    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^(void){
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if(rv == 0) {
                ...
                if(ret != KERN_SUCCESS) {
                    [self.respringButton setTitle:@"No connection :/" forState:UIControlStateNormal];
                    return;
                    
                }
                
                [self.respringButton setTitle:@"Wait few seconds..." forState:UIControlStateNormal];
                ...
                dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 1 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        [self.respringButton setTitle:@"respring.." forState:UIControlStateNormal];
                        
                        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 2 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{

                            printf("[INFO]: respring..\n");
