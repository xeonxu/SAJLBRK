...
int kstruct_offsets_15B202[] = {
  ...
  0x26c, // KSTRUCT_OFFSET_PROC_COMM,
...
//iPhoneX
uint64_t ksymbols_iphone_X_11_1_2[] = {
    0xfffffff0074d74cc, // KSYMBOL_OSARRAY_GET_META_CLASS,
    0xFFFFFFF007532CEC, // KSYMBOL_IOUSERCLIENT_GET_META_CLASS (IOUserClient::getMetaClass)
    0xFFFFFFF007534494, // KSYMBOL_IOUSERCLIENT_GET_TARGET_AND_TRAP_FOR_INDEX (IOUserClient::getTargetAndTrapForIndex)
    0xFFFFFFF0073B19A4, // KSYMBOL_CSBLOB_GET_CD_HASH (_csblob_get_cdhash)
    0xfffffff007101248, // KSYMBOL_KALLOC_EXTERNAL
    0xfffffff007101278, // KSYMBOL_KFREE
    0xFFFFFFF0070C07DC, // KSYMBOL_RET (any ret)
    0xfffffff0074f11cc, // KSYMBOL_OSSERIALIZER_SERIALIZE,
    0xfffffff00758c618, // KSYMBOL_KPRINTF
    0xfffffff0074fc164, // KSYMBOL_UUID_COPY
    0xfffffff0075b2000, // KSYMBOL_CPU_DATA_ENTRIES
...
//iPhone 5S
uint64_t ksymbols_iphone_5s_15b202[] = {
